...
export default function SupportPage() {
  ...
  useEffect(() => {
    scrollToBottom();
  }, [messages, isTyping, stagedAttachment, scrollToBottom]);
          ...
          {loading ? (
            ...
            <div className="grid items-start grid-cols-1 gap-8 lg:grid-cols-12">
              ...
              <div className="lg:col-span-8 bg-white border border-slate-200 shadow-sm rounded-[24px] overflow-hidden flex flex-col h-[750px]">
                 ...
                 <div 
                   ref={chatScrollRef}
                   className="flex-1 p-6 space-y-6 overflow-y-auto md:p-8 bg-slate-50/30 custom-scrollbar scroll-smooth"
                 >
