...
export default function ApplicationTracker() {
  ...
  const handleCloseTaskModal = (force = false) => {
    // Prevent accidental closure if data is staged, unless forced (clicking X or Cancel)
  ...
  return (
    <>
      ...
      {/* --- 3. 🟢 TASK RESOLUTION MODAL (Full End-to-End Flow) --- */}
      {activeTask && (
            ...
            <form className="p-6 overflow-y-auto md:p-8" onSubmit={handleCompleteTask}>
              ...
              <div className="flex justify-end gap-3 pt-8 shrink-0">
                ...
                <button 
                  ...
                  className="px-8 py-3 text-sm font-bold text-white bg-[#B91C1C] hover:bg-red-800 rounded-xl transition-all shadow-md active:scale-95 disabled:opacity-50 flex items-center gap-2"
                >
...
const ZeroState = ({ activeTab }) => (
  <div className="flex flex-col items-center justify-center p-12 text-center bg-white border border-slate-200 shadow-sm rounded-[24px] mt-8 py-24">
    ...
    {activeTab === 'active' && (
      <Link href="/borrower/explore" className="flex items-center gap-2 px-8 py-4 bg-[#B91C1C] text-white font-bold rounded-xl hover:bg-red-800 transition-all shadow-md active:scale-95">
...
ApplicationTracker.getLayout = (page) => (
