...
export default function PreApprovalsPage() {
  ...
  const handleRequestSubmit = async (e) => {
    ...
    setRequestForm({ price: '', downPayment: '', income: '', location: '' }); // Reset
        ...
        {loading ? (
          ...
          <div className="grid items-start grid-cols-1 gap-8 lg:grid-cols-12">
              ...
              {activeLetter ? (
                <div className="flex flex-col bg-white border border-slate-200 shadow-xl shadow-slate-200/50 rounded-[24px] overflow-hidden">
                  ...
                  <div className="p-8 bg-white md:p-10">
                    ...
                    {/* Master Action Buttons - US Market Optimized */}
            ...
            <div className="space-y-6 lg:col-span-4">
              ...
              {/* History List */}
              <div className="p-6 md:p-8 bg-white border border-slate-200 rounded-[24px] shadow-sm flex flex-col max-h-[500px]">
...
PreApprovalsPage.getLayout = (page) => (
