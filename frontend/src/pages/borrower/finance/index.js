...
import { 
  ...
  Building, Activity, Unlink, PieChart, DollarSign, Eye // 🟢 FIX: Missing Eye import added
} from 'lucide-react';
...
// 🟢 FIX: Standardized Button Primitive
          ...
          <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
            ...
            <div className="flex items-center w-full gap-3 sm:w-auto">
               <Button 
                 ...
                 className="flex-1 gap-2 h-11 sm:flex-none border-slate-200 text-slate-700 hover:bg-slate-50"
               >
               ...
               <Button 
                 ...
                 className="flex-1 gap-2 text-white shadow-md h-11 bg-slate-900 hover:bg-slate-800 sm:flex-none"
               >
                    ...
                    <div className="p-6 space-y-6 md:p-8 bg-slate-50/30">
                       {financialData.connections.length === 0 ? (
                          <div className="py-12 text-center">
                             ...
                             <Button onClick={openLinkModal} className="px-6 bg-red-600 shadow-md hover:bg-red-700">
                               Securely Connect
                             </Button>
                          </div>
                       ) : (
                    ...
                    {POPULAR_BANKS.map(bank => (
                      <button 
                        ...
                        className={cn(
                          ...
                          "hover:shadow-lg hover:-translate-y-0.5 border border-transparent hover:border-slate-300"
                        )}
                      >
